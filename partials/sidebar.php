<!-- â•â• SIDEBAR MOBILE OVERLAY â•â• -->
  ...
  <div class="modal-overlay" id="logoutModal">
    <div class="logout-modal">
      ...
      <p class="logout-desc">Anda akan keluar dari sesi ini. Pastikan semua pekerjaan Anda telah tersimpan sebelum
        melanjutkan.</p>
      <div class="logout-btns">
        <button class="btn-modal-cancel" onclick="closeLogoutModal()">Batal</button>
        <button class="btn-modal-confirm" onclick="window.location.href='login-ppid.html'">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <a class="sidebar-brand" href="#">
        ...
        <div class="brand-text">
          ...
          <div class="brand-sub">Kota Pekalongan Â· v2.0</div>
        </div>
      </a>
      ...
      <nav class="sidebar-scroll">
        ...
        <div class="nav-item-wrapper">
          <a href="#" class="nav-link-custom active" data-tip="Dashboard">
        ...
        <div class="nav-item-wrapper">
          <a href="#" class="nav-link-custom" data-tip="Admin Pengelola">
        ...
        <div class="nav-item-wrapper">
          <a href="#" class="nav-link-custom" data-tip="Riwayat Permohonan">
      ...
      <div class="sidebar-footer">
        <div class="sidebar-footer-inner">
          ...
          <div class="sf-text">
            <div class="sf-version">Versi 2.0.1 â€” Stabil</div>
